...
public class CreateAccountG extends JFrame {
    ...
    private JButton registro = new JButton("Crear");
    
    public CreateAccountG () {
    ...
    private void init() {
        ...
        Titulo.setBounds(160, 10, 700, 100);
        ...
        PanelPrincipal.setBounds(350, 100, 340, 600);
        ...
        //Registrar
        registro.setBounds(20, 520, 300, 45);
